  ...
  return (
    <div className="h-screen bg-white px-6 flex flex-col justify-center overflow-hidden text-neutral-900 font-inter">
      <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-sm mx-auto">
        <div className="h-20 w-20 bg-blue-600 rounded-[2rem] flex items-center justify-center mb-8 shadow-2xl shadow-blue-600/40 text-white font-black text-3xl">
          D
        </div>
        <h1 className="text-5xl font-black tracking-tighter leading-tight mb-2">Welcome<br/>Back.</h1>
        ...
        <div className="text-center mt-12">
          <p className="text-xs font-bold text-neutral-400">
            New here? <Link to="/user/register" className="text-blue-600 border-b-2 border-blue-100 pb-0.5">Create Account</Link>
          </p>
        </div>
      </motion.div>
    </div>
