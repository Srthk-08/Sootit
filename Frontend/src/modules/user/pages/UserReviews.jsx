...
const UserReviews = () => {
    ...
    const reviews = [
        { id: "REV-1291", expert: "Amit Vikram", type: "Expert Driver", date: "Today", rating: 5, comment: "Excellent driving skills, very professional.", clr: "bg-blue-100 text-blue-600" },
        { id: "REV-1112", expert: "Sharma Garage", type: "Full Service", date: "Yesterday", rating: 4, comment: "Good service, but took slightly longer than expected.", clr: "bg-orange-100 text-orange-600" },
    ];
            ...
            <div className="p-4 space-y-4">
                {reviews.map((rev, idx) => (
                    ...
                    >
                        ...
                        <p className="text-[10px] font-bold text-neutral-500 italic leading-relaxed border-l-2 border-blue-100 pl-3">"{rev.comment}"</p>
                    </motion.div>
                ))}
            </div>
        </div>
